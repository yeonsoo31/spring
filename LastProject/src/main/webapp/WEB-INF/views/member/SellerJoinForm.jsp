...
<body>
	<form action="sellerJoin" method="post" id="sellerJoinForm" onsubmit="return doubleCheck()"	enctype="multipart/form-data">
		<table>
			<tr>
				<td>상호명(단체명) : <input type="text" id="b_name" name="b_name"></td>
			</tr>
			<tr>
				<td>사업자등록번호 : <input type="text" id="b_number" name="b_number" maxlength="12" placeholder="000-00-00000">
