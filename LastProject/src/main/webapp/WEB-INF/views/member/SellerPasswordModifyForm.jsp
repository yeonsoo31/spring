...
<script>
	function doubleCheck(){
		...
		var sellerOldPassword = document.getElementById("sellerOldPassword");
		...
		if(sellerOldPassword.value == password.value){
...
<body>
	<form action="newSellerPassword" method="post" onsubmit="return doubleCheck()">
		...
		<input type="hidden" id="sellerOldPassword" value="${sessionScope.seller.password}">
